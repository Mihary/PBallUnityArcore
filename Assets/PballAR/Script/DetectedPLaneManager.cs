...
public class DetectedPLaneManager : MonoBehaviour
{
    /// <summary>
    ...
    public static DetectedPLaneManager instance = null; //RK

    public List<GameObject> PLANES = new List<GameObject>(); //MA
